...
data_root = './cityscapes/original___fixed_label_03/data'
...
launcher = 'none'
work_dir = './work_dirs/roadformer_convnext-b_cityscapes-512x1024___original___fixed_label_03___non-pretrained'
