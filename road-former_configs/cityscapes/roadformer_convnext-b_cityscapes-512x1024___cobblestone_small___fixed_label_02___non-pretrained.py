...
data_root = './cityscapes/cobblestone_small___fixed_label_02/data'
...
launcher = 'none'
work_dir = './work_dirs/roadformer_convnext-b_cityscapes-512x1024___cobblestone_small___fixed_label_02___non-pretrained'
