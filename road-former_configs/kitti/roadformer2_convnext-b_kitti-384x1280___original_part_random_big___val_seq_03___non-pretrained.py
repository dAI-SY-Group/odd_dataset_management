...
data_root = './kitti_road/original_part_random_big___val_seq_03/data/KITTI'
...
launcher = 'none'
work_dir = './work_dirs/roadformer2_convnext-b_kitti-384x1280___original_part_random_big___val_seq_03___non-pretrained'
