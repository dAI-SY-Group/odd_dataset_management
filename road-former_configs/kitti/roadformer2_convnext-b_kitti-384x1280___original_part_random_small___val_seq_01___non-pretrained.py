...
data_root = './kitti_road/original_part_random_small___val_seq_01/data/KITTI'
...
launcher = 'none'
work_dir = './work_dirs/roadformer2_convnext-b_kitti-384x1280___original_part_random_small___val_seq_01___non-pretrained'
