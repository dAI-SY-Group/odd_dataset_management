...
data_root = './kitti_road/original___val_seq_02/data/KITTI'
...
launcher = 'none'
work_dir = './work_dirs/roadformer2_convnext-b_kitti-384x1280___original___val_seq_02___non-pretrained'
